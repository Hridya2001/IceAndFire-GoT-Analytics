...
In the end, this project shows that Game of Thrones is more than a fantasy tale—it is a narrative that can be measured, quantified, and visualized through data. By examining episode appearances, dialogue distribution, and house dynamics, I uncovered how individual characters rose and fell, how families gained and lost influence, and how the narrative spotlight shifted across the Seven Kingdoms. The analysis makes clear that the saga’s richness lies in its ensemble—where no single character or house dominated forever, but instead contributed to an evolving balance of power. Just like the realm it depicts, the story thrives on change, and the data confirms that in the game of thrones, nothing is permanent.
